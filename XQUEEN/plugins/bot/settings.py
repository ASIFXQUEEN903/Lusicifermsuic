...
from XQUEEN.utils.decorators.admins import ActualAdminCB
from XQUEEN.utils.decorators.language import language, languageCB
from XQUEEN.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from XQUEEN.utils.inline.start import private_panel
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data=f"AU")]]
        ),
    )
