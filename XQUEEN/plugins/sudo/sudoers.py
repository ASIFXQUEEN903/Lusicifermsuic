...
from XQUEEN.misc import SUDOERS
from XQUEEN.utils.database import add_sudo, remove_sudo
from XQUEEN.utils.decorators.language import language
from XQUEEN.utils.extraction import extract_user
...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_video(video="https://files.catbox.moe/toawnw.mp4", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("QUEEN APKO NAHI JANTI 🕊️ \n TUM NAHI DEKH SAKTE HO KON CONTROL KARSAKTE HAI💘", show_alert=True)
    else:
